...
class UserController{
    ...
    userCreatepage(req: Request, res: Response){
        res.render('createuser')
    }

    userDeletepage(req: Request, res: Response){
    ...
    async createUsuarios(req: Request, res: Response){
        ...
        const matriculaNumero: number = parseInt(matricula, 10);
        const tipoUsuarioNumero: number = parseInt(tipoUsuario, 10);
